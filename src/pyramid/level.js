// pyramid/level.js — 지도 「저주받은 거울의 무덤」 문제 1 기준 무대 수치.
...
export const LV = {
  ...
  props: {
    keySpot: [-4.2, 0.45, -0.9],     // 과거 1: 문지기의 좌대 위 열쇠 / 현재: 돌무더기 밑 (콜드 오픈: 거울과의 기준선 2.94m)
    keyStand: [-4.2, 0, -0.15],
  ...
  eraObstacles: {
    P1: [
      { x0: -4.38, x1: -4.02, z0: -1.08, z1: -0.72 },
      { x0: -7.5, x1: -6.35, z0: -3, z1: -1.1 },
      { x0: -7.5, x1: -6.35, z0: 1.1, z1: 3 },
    ],
    PRESENT: [{ x0: -4.8, x1: -3.6, z0: -1.5, z1: -0.3 }],
  },
