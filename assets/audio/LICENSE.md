...
- `dungeon_ambient.ogg` — [Loopable Dungeon Ambience](https://opengameart.org/content/loopable-dungeon-ambience) (CC0). 현재 시대 앰비언스.
...
- `steps/Fantozzi-Stone{L,R}{1,2,3}.ogg` — [Fantozzi's Footsteps](https://opengameart.org/content/fantozzis-footsteps-grasssand-stone) (CC0). 돌바닥 발소리.
